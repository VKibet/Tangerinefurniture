...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/konstaco/domains/tangerinefurniture.co.ke/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/konstaco/domains/tangerinefurniture.co.ke/awstats/.data",
